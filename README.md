...
The KSHub by Kappa Sigma is a one-stop hub for activity within the organization. The app features an announcements board with a commenting feature, an events page, a merchandise page, and a roster of all active members of the Texas A&M University chapter. The app also features admin permissions to create, delete, and update information on the site.
...
CI/CD has been implemented in the GitHub Actions in the repo here -> https://github.com/mahirahsamah/kshub/actions 
